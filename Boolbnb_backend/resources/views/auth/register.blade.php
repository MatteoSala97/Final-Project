<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="surname" class="block mt-1 w-full" type="text" name="surname" placeholder="Surname *" :value="old('surname')"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" placeholder="Email *" :value="old('email')"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="birth_date" type="date" name="birth_date" value="{{ old('birth_date') }}" required autofocus
                autocomplete="birth_date" class="form-input rounded-md shadow-sm mt-1 block w-full text-gray-500"
        ...
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('')" />
            <x-text-input id="phone_number" type="text" name="phone_number" placeholder="Phone Number" value="{{ old('phone_number') }}" autofocus
        ...
        <div class="mt-4">
            ...
            <label id="file-name-container" for="user_propic" class="form-input rounded-md shadow-sm mt-1 block w-full border-gray-300 text-gray-500">
                Select file
            </label>
